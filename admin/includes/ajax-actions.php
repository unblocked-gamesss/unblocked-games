				...
				if(isset($_FILES['file-0'])){
					...
					if($ok){
						if (move_uploaded_file($file_to_upload["tmp_name"], $target_file)) {
							echo '{"result": [{"url":"'.$uploaded_url.'", "name":"'.$file_to_upload["name"].'", "size":'.$file_to_upload['size'].'}]}';
						} else {
