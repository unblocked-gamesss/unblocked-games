				...
				<nav aria-label="Page navigation example">
					<ul class="pagination justify-content-center">
						...
						if($total_page){
							...
							if($start > 0){
								echo '<li class="page-item"><a class="page-link" href="'. get_permalink('tag', $_GET['slug'], array('page' => 1)) .'">1</a></li>';
							...
							for($i = $start; $i<$end; $i++){
								...
								echo '<li class="page-item '.$disabled.'"><a class="page-link" href="'. get_permalink('tag', $_GET['slug'], array('page' => $i+1)) .'">'.($i+1).'</a></li>';
							}
							if($end < $total_page){
								echo('<li class="page-item disabled"><span class="page-link">...</span></li>');
								echo '<li class="page-item"><a class="page-link" href="'. get_permalink('tag', $_GET['slug'], array('page' => $total_page)) .'">'.$total_page.'</a></li>';
							}
						}
						?>
					</ul>
